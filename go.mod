...
require (
	...
	sigs.k8s.io/cluster-api-operator v0.0.0-20230209153622-5386dd335285
...
replace (
	sigs.k8s.io/cluster-api => github.com/openshift/cluster-api v0.0.0-20221209114127-1101b984bc6d
