...
func StartEnvTest(testEnv *envtest.Environment) (*rest.Config, client.WithWatch, error) {
	...
	testEnv.CRDInstallOptions = envtest.CRDInstallOptions{
		Paths: []string{
			...
			path.Join(openshiftAPIPath, "config", "v1", "zz_generated.crd-manifests", "0000_10_config-operator_01_apiservers-Default.crd.yaml"),
			path.Join(openshiftAPIPath, "config", "v1", "zz_generated.crd-manifests", "0000_10_config-operator_01_infrastructures-SelfManagedHA-TechPreviewNoUpgrade.crd.yaml"),
