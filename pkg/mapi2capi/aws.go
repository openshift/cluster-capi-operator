...
// AWSProviderSpecAndInfra stores the details of a MAPI AWSProviderSpec and Infra.
type AWSProviderSpecAndInfra struct {
	Spec           *mapiv1.AWSMachineProviderConfig
	Infrastructure *configv1.Infrastructure
}

// AWSMachineAndInfra stores the details of a MAPI Machine and Infra.
type AWSMachineAndInfra struct {
	Machine        *mapiv1.Machine
	Infrastructure *configv1.Infrastructure
}

// AWSMachineSetAndInfra stores the details of a MAPI MachineSet and Infra.
type AWSMachineSetAndInfra struct {
	MachineSet     *mapiv1.MachineSet
	Infrastructure *configv1.Infrastructure
}

// FromAWSProviderSpecAndInfra wraps a MAPI AWSMachineProviderConfig and an Infrastructure object into a mapi2capi AWSProviderSpecAndInfra object.
...
// FromAWSMachineAndInfra wraps a MAPI Machine and an Infrastructure object into a mapi2capi AWSMachineAndInfra object.
...
// FromAWSMachineAndInfra wraps a MAPI MachineSet and an Infrastructure object into a mapi2capi AWSMachineSetAndInfra object.
...
// ToMachineAndMachineTemplate converts a MAPI Machine, wrapped in a mapi2capi AWSMachineAndInfra object, to a CAPI Machine and CAPA AWSMachineTemplate
...
// ToMachineSetAndMachineTemplate converts a MAPI MachineSet, wrapped in a mapi2capi AWSMachineSetAndInfra object, to a CAPI MachineSet and CAPA AWSMachineTemplate
...
// (AWSProviderSpecAndInfra).ToMachineTemplateSpec() implements the ProviderSpec conversion interface for the AWS provider.
