...
func CAPIMachineSetFuzzerFuncs(infraTemplateKind, infraAPIVersion, clusterName string) fuzzer.FuzzerFuncs {
	return func(codecs runtimeserializer.CodecFactory) []interface{} {
		return []interface{}{
			...
			func(m *clusterv1.MachineSetStatus, c fuzz.Continue) {
				c.FuzzNoCustom(m)
...
func MAPIMachineSetFuzzerFuncs() fuzzer.FuzzerFuncs {
	return func(codecs runtimeserializer.CodecFactory) []interface{} {
		return []interface{}{
			...
			func(m *mapiv1.MachineSetStatus, c fuzz.Continue) {
				c.FuzzNoCustom(m)
...
func fuzzCAPIMachineSetV1Beta2Status(status *clusterv1.MachineSetStatus, c fuzz.Continue) {
	if status == nil {
		return
	}
