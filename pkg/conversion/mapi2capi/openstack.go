...
//
//nolint:dupl
func (m *openstackMachineSetAndInfra) ToMachineSetAndMachineTemplate() (*clusterv1.MachineSet, client.Object, []string, error) {
	var (
		errors   []error
		warnings []string
	)
...
func openstackMachineToOpenStackMachineTemplate(openstackMachine *openstackv1.OpenStackMachine, name string, namespace string) *openstackv1.OpenStackMachineTemplate {
