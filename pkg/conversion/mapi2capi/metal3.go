...
func (m *metal3MachineAndInfra) toMachineAndInfrastructureMachine() (*clusterv1.Machine, client.Object, []string, field.ErrorList) {
	...
	capaMachine, warn, machineErrs := m.toMetal3Machine(baremetalProviderConfig)
	if machineErrs != nil {
...
func (m *metal3MachineSetAndInfra) ToMachineSetAndMachineTemplate() (*clusterv1.MachineSet, client.Object, []string, error) {
	...
	capaMachine, ok := capaMachineObj.(*metal3v1.Metal3Machine)
	if !ok {
		panic(fmt.Errorf("%w: %T", errUnexpectedObjectTypeForMachine, capaMachineObj))
	}

	capaMachineTemplate, err := metal3MachineToMetal3MachineTemplate(capaMachine, m.machineSet.Name, capiNamespace)
	if err != nil {
