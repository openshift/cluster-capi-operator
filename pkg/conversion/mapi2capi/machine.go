...
func convertMAPIMachineToCAPIMachineStatus(mapiMachine *mapiv1beta1.Machine) clusterv1.MachineStatus {
	...
	// - ProviderStatus: this is provider-specific and handled by separate infrastructure resources in CAPI.
...
func convertMAPIMachineConditionsToCAPIMachineV1Beta2StatusConditions(mapiMachine *mapiv1beta1.Machine) []metav1.Condition {
	...
	availableCondition := metav1.Condition{
		...
		Reason: func() string {
			if mapiMachine.Status.Phase != nil && *mapiMachine.Status.Phase == mapiv1beta1.PhaseRunning {
				return clusterv1.MachineAvailableV1Beta2Reason
			}

			return clusterv1.NotAvailableV1Beta2Reason
		}(),
		// LastTransitionTime will be set by the condition utilities.
	}
