...
func (m machineAndVSphereMachineAndVSphereCluster) toProviderSpec() (*mapiv1beta1.VSphereMachineProviderSpec, []string, field.ErrorList) {
	...
	// PowerOffMode - VSphereMachine lifecycle field, not part of the provider spec.
	// GuestSoftPowerOffTimeout - VSphereMachine lifecycle field, not part of the provider spec.
	// NamingStrategy - VSphereMachine lifecycle field, not part of the provider spec.
	...
	// AdditionalDisksGiB - Deprecated in CAPV in favor of DataDisks.
...
func handleUnsupportedVSphereFields(fldPath *field.Path, spec vspherev1.VSphereMachineSpec) field.ErrorList {
	...
	if len(spec.AdditionalDisksGiB) > 0 {
		// This field is deprecated in CAPV in favor of DataDisks.
		errs = append(errs, field.Invalid(fldPath.Child("additionalDisksGiB"), spec.AdditionalDisksGiB, "additionalDisksGiB is not supported, use dataDisks instead"))
	}
