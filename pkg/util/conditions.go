...
var (
	errObjectNotRuntimeUnstructured = errors.New("object does not implement runtime.Unstructured")
	errStatusNotMap                 = errors.New("unable to assert status structure to map")
	errStatusConditionsNotInterface = errors.New("unable to assert status.condition structure to inteface")
)
