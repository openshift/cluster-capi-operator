...
func toClusterOperator(ctx context.Context, cO client.Object) []reconcile.Request {
	return []reconcile.Request{{
		NamespacedName: client.ObjectKey{Name: clusterOperatorName, Namespace: cO.GetNamespace()},
	}}
}

// coreClusterPredicate defines a predicate function for the owned coreCluster.
func coreClusterPredicate(namespace string) predicate.Funcs {
	return predicate.Funcs{
		CreateFunc:  func(e event.CreateEvent) bool { return isOwnedCoreCluster(e.Object, namespace) },
		UpdateFunc:  func(e event.UpdateEvent) bool { return isOwnedCoreCluster(e.ObjectNew, namespace) },
		DeleteFunc:  func(e event.DeleteEvent) bool { return isOwnedCoreCluster(e.Object, namespace) },
		GenericFunc: func(e event.GenericEvent) bool { return isOwnedCoreCluster(e.Object, namespace) },
	}
}

// isOwnedCoreCluster checks whether an object is an owned provider component.
func isOwnedCoreCluster(obj runtime.Object, namespace string) bool {
