...
// InitManager initialises a manager and adds a CompatibilityRequirementReconciler to
...
// appropriate time.
var InitManager func(context.Context) (*CompatibilityRequirementReconciler, func())

func TestAPIs(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "CompatibilityRequirement Controller Suite")
}
...
var _ = BeforeSuite(func(ctx context.Context) {
	...
	InitManager = func(ctx context.Context) (*CompatibilityRequirementReconciler, func()) {
		return initManager(ctx, cfg, cl.Scheme(), testEnv)
	}
}, NodeTimeout(30*time.Second))

func initManager(ctx context.Context, cfg *rest.Config, scheme *runtime.Scheme, testEnv *envtest.Environment) (*CompatibilityRequirementReconciler, func()) {
