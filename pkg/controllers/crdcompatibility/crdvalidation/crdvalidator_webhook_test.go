...
func Test_crdValidator_validateCreateOrUpdate(t *testing.T) { //nolint:funlen
	...
	tests := []struct {
		...
		},
		{
			...
			wantWarnings: ConsistOf("This requirement was added by CompatibilityRequirement : removed field : v1.^.foo1"),
		},
		{
			...
			wantWarnings: ConsistOf(
				"This requirement was added by CompatibilityRequirement : removed field : v1.^.foo1",
				"This requirement was added by CompatibilityRequirement : removed field : v1.^.foo2",
			),
		},
	}
