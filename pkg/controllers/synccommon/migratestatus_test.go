...
var _ = Describe("IsMigrationCancellationRequested", func() {
	DescribeTable("should correctly identify migration cancellation scenarios",
		func(
			...
			expectedMigrationCancellation bool,
		) {
			result := IsMigrationCancellationRequested(specAuthoritativeAPI, statusAuthoritativeAPI, statusSynchronizedAPI)
		...
		Entry("Not a migration cancellation - migration to ClusterAPI in progress",
			mapiv1beta1.MachineAuthorityClusterAPI,
			mapiv1beta1.MachineAuthorityMigrating,
			mapiv1beta1.MachineAPISynchronized,
			false,
		),
		Entry("Not a migration cancellation - migration to MachineAPI in progress",
			mapiv1beta1.MachineAuthorityMachineAPI,
			mapiv1beta1.MachineAuthorityMigrating,
			mapiv1beta1.ClusterAPISynchronized,
			false,
		),
		Entry("Not a migration cancellation - migration to ClusterAPI requested but not yet started",
			mapiv1beta1.MachineAuthorityClusterAPI,
			mapiv1beta1.MachineAuthorityMachineAPI,
			mapiv1beta1.MachineAPISynchronized,
			false,
		),
		Entry("Not a migration cancellation - migration to MachineAPI requested but not yet started",
			mapiv1beta1.MachineAuthorityMachineAPI,
			mapiv1beta1.MachineAuthorityClusterAPI,
			mapiv1beta1.ClusterAPISynchronized,
			false,
