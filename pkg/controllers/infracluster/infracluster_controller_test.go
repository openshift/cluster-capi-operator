...
var _ = Describe("InfraCluster", func() {
	...
	Context("When there is no InfraCluster", func() {
		Context("When there is an active ControlPlaneMachineSet", func() {
			BeforeEach(func() {
				internalLB := []mapiv1beta1.LoadBalancerReference{{Name: "testClusterID-ext", Type: mapiv1beta1.NetworkLoadBalancerType}, {Name: "testClusterID-int", Type: mapiv1beta1.NetworkLoadBalancerType}}
