...
func (r *InfraClusterController) ensureNutanixCluster(ctx context.Context, log logr.Logger) (client.Object, error) {
	...
	clusterSpec := r.buildNutanixClusterSpec(apiURL, int32(port))
...
// buildNutanixClusterSpec constructs NutanixClusterSpec from the Infrastructure resource.
func (r *InfraClusterController) buildNutanixClusterSpec(apiURL *url.URL, port int32) nutanixv1.NutanixClusterSpec {
