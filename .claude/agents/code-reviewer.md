...
- ✅ Correct `Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error)` signature
- ✅ Proper RBAC markers (`//+kubebuilder:rbac`)
- ✅ Controller registration with manager
- ✅ Error handling with appropriate requeue logic
...
- ✅ Bidirectional sync between MAPI and CAPI
- ✅ Proper conversion patterns in `pkg/conversion/`
