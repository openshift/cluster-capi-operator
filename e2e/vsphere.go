...
var _ = Describe("[sig-cluster-lifecycle][Feature:ClusterAPI] Cluster API vSphere MachineSet", Ordered, Label("Platform:vsphere"), Label("Serial"), Label("Disruptive"), func() {
