...
func GetMachines(cl client.Client, ctx context.Context, selectors ...*metav1.LabelSelector) ([]*clusterv1.Machine, error) {
...
func DeleteMachines(cl client.Client, ctx context.Context, namespace string, machines ...*clusterv1.Machine) error {
