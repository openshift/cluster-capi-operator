...
<<<<<<< HEAD:hack/assets/vendor/golang.org/x/sys/unix/zsyscall_aix_ppc.go
func ioctlPtr(fd int, req uint, arg unsafe.Pointer) (err error) {
=======
func ioctlPtr(fd int, req int, arg unsafe.Pointer) (err error) {
>>>>>>> c8862839 (assets generation refactor):assets/vendor/golang.org/x/sys/unix/zsyscall_aix_ppc.go
