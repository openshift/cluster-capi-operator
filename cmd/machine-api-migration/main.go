...
func main() {
	...
	machineReconciler := machinesync.MachineSyncReconciler{
		Platform: provider,
	...
	machineSetReconciler := machinesetsync.MachineSetSyncReconciler{
		Platform: provider,
	...
	if err := machineSetReconciler.SetupWithManager(mgr); err != nil {
